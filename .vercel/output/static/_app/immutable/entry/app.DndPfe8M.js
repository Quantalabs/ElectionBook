function __vite__mapDeps(indexes) {
	if (!__vite__mapDeps.viteFileDeps) {
		__vite__mapDeps.viteFileDeps = [
			'../nodes/0.Ct44vyR2.js',
			'../chunks/scheduler.Cz8KL0TK.js',
			'../chunks/index.CUnrqcbe.js',
			'../nodes/1.BBqR8jKP.js',
			'../chunks/entry.CtFk_Cld.js',
			'../nodes/2.DFRtc4mo.js',
			'../assets/2.DpunoM9F.css'
		];
	}
	return indexes.map((i) => __vite__mapDeps.viteFileDeps[i]);
}
import { s as V, d as B, o as U, e as A, t as j } from '../chunks/scheduler.Cz8KL0TK.js';
import {
	S as W,
	i as z,
	s as F,
					...
					if (
						...
						return new Promise((b, v) => {
							_.addEventListener('load', b),
								_.addEventListener('error', () => v(new Error(`Unable to preload CSS for ${o}`)));
						});
				})
			);
		}
		...
		s && ((e = E(s, u(a))), a[11](e)),
		{
			...
			p(t, r) {
				if (r & 2 && s !== (s = t[1][0])) {
					...
					const o = {};
					r & 8 && (o.data = t[3]), r & 8215 && (o.$$scope = { dirty: r, ctx: t }), e.$set(o);
				}
			},
			i(t) {
				i || (e && g(e.$$.fragment, t), (i = !0));
...
const ae = [
		() => C(() => import('../nodes/0.Ct44vyR2.js'), __vite__mapDeps([0, 1, 2]), import.meta.url),
		() => C(() => import('../nodes/1.BBqR8jKP.js'), __vite__mapDeps([3, 1, 2, 4]), import.meta.url),
		() => C(() => import('../nodes/2.DFRtc4mo.js'), __vite__mapDeps([5, 1, 2, 6]), import.meta.url)
	],
	le = [],
	fe = { '/': [2] },
	ce = {
