import { s as S, n as _, b as x } from '../chunks/scheduler.Cz8KL0TK.js';
import {
	S as j,
	i as k,
	e as f,
...
import { s as C } from '../chunks/entry.CtFk_Cld.js';
const H = () => {
		const s = C;
		return {
	...
	return {
		...
		p(e, [a]) {
			...
			a & 1 && r !== (r = e[0].status + '') && E(o, r),
				a & 1 && c !== (c = ((p = e[0].error) == null ? void 0 : p.message) + '') && E(u, c);
		},
		i: _,
		o: _,
		d(e) {
